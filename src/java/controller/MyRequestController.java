 ...
 * @author ADMIN
 */
@WebServlet(name = "MyRequestController", urlPatterns = {"/my-request"})
public class MyRequestController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null && user.getRole().equals(Role.MENTEE)) {
            ...
            System.out.println(pagingRequests);

            request.setAttribute("request", pagingRequests);
            request.setAttribute("title", "My Request");
            ...
            request.getRequestDispatcher("my-request.jsp").forward(request, response);
        } else {
