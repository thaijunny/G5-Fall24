    ...
    <main class="ttr-wrapper">
        <div class="container-fluid">
            ...
            <div class="db-breadcrumb">
                <h4 class="breadcrumb-title">List Recharge</h4>
                <ul class="db-breadcrumb-list">
                    <li><a href="${pageContext.request.contextPath}/manager/dashboard"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="${pageContext.request.contextPath}/manager/manage-recharge">Recharge List</a></li>
            </ul>
        </div>
        ...
        <!-- Filter Section -->
        <form action="manage-recharge" method="get">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group" style="width: 80%">
                            <input type="text" class="form-control" name="search" placeholder="Enter account or full name to search" value="${param.search}">
                        </div>
                    </div>
                </div>
                <div class="feature-filters clearfix center m-b40 col-md-4" style="text-align: right; margin-top: 9px">
                    <ul class="filters">
                        <li class="btn ${param.status == null || param.status == '' ? 'active' : ''}">
                            <a href="manage-recharge?search=${param.search}&status=&page=1"><span>All</span></a>
                        </li>
                        <li class="btn ${param.status eq 'PENDING' ? 'active' : ''}">
                            <a href="manage-recharge?search=${param.search}&status=PENDING&page=1"><span>PENDING</span></a>
                        </li>
                        <li class="btn ${param.status eq 'REJECTED' ? 'active' : ''}">
                            <a href="manage-recharge?search=${param.search}&status=REJECTED&page=1"><span>REJECTED</span></a>
                        </li>
                        <li class="btn ${param.status eq 'APPROVED' ? 'active' : ''}">
                            <a href="manage-recharge?search=${param.search}&status=APPROVED&page=1"><span>APPROVED</span></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="s" items="${payments}" varStatus="status">
                            <tr>
                                <td>${status.index + 1}</td>
                                <td>${s.mentee.user.fullname}</td>
                                <td>${s.mentee.user.account}</td>
                                <td>${s.mentee.user.email}</td>
                                <td>${s.amount} VND</td>
                                <td>${s.createdDate}</td>
                                <td>
                                    <c:choose>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure you want to approve this Recharge?</p>
                                    </div>
                                    <div class="modal-footer">
                                        <form action="${pageContext.request.contextPath}/manager/manage-recharge" method="post">
                        ...
                        <div class="modal fade" id="activateSkillModal-${s.id}" tabindex="-1" aria-labelledby="activateSkillModal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure you want to reject this Recharge?</p>
                                    </div>
                                    <div class="modal-footer">
                                        <form action="${pageContext.request.contextPath}/manager/manage-recharge" method="post">
                                            <input type="hidden" name="id" value="${s.id}">
